...
f = 1                           # Nombre maximum de crashs
total_rounds = f + 1            # Nombre de rounds à exécuter
default_value = 0               # Valeur par défaut v0

# Valeurs initiales de chaque processus (indices 0 à n-1)
...
# crashed[i] = True si le processus i est CRASHED
crashed = [False] * n
...
def receive_and_merge(process_id, messages_received):
    """
